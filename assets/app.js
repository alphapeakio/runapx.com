...
(function () {
  ...
  function frame(ts) {
    ...
    for (var i = 0; i < panes.length; i++) {
      ...
      /* Fill strength: solid while the pane is pinned in the centre (the
         dwell, where the copy is being read), easing back toward frost only
         once it is half a screen away and travelling out. */
      ...
      el.style.setProperty('--glass-a1', (0.70 + settle * 0.27).toFixed(3));
      el.style.setProperty('--glass-a2', (0.58 + settle * 0.35).toFixed(3));
    }
